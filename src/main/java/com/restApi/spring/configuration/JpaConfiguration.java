package com.restApi.spring.configuration;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "com.restApi.spring.repositories",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "com.restApi.spring.model" });
